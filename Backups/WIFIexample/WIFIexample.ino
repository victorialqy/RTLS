...
#define esp8266_reset_pin 3 // Connect this pin to CH_PD on the esp8266, not reset. (let reset be unconnected)

#define SERVER_PORT "2121"
#define SSID "VICTORIA.L"
#define PASSWORD "98524876"
...
void setup() {
  ...
  if (wifi_started) {
    ...
    Serial.println("WIFI WERKING");
  } else {
    // ESP8266 isn't working..
    Serial.println("WIFI NOT WERKING");
  }
}
